...
### (2-6) PROTON-GE ADDITIONAL CUSTOM PATCHES ###
    ...
    patch -Np1 < ../patches/wine-hotfixes/pending/wine-wayland/0150-ntoskrnl-Add-some-stubs-and-implementations.patch
    patch -Np1 < ../patches/wine-hotfixes/pending/wine-wayland/0151-ntoskrnl-Implement-some-instructions-used-for-VM-det.patch
    patch -Np1 < ../patches/wine-hotfixes/pending/wine-wayland/0152-ntoskrnl-Implement-more-functions.patch
    patch -Np1 < ../patches/wine-hotfixes/pending/wine-wayland/0153-ntoskrnl-Implement-and-add-more-stubs.patch
    ...
    patch -Np1 < ../patches/wine-hotfixes/pending/wine-wayland/0157-ntoskrnl-Implement-some-token-related-methods.patch
    patch -Np1 < ../patches/wine-hotfixes/pending/wine-wayland/0158-ntoskrnl-Refactor-token-object.patch
